...
def scorekeeper():
    if (button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X"):
        ...
        score = (n+1)
        PlayerX.set(score)
        tkinter.messagebox.showinfo("Pypower Tic Tac Toe","Player X Won The Game!!")
        reset()
    ...
    if (button1["text"] == "O" and button2["text"] == "O" and button3["text"] == "O"):
        ...
        score = (n+1)
        PlayerO.set(score)
        tkinter.messagebox.showinfo("Pypower Tic Tac Toe","Player O Won The Game!!")
        reset()
...
txtPlayerX=Button(RightFrame1,font=('arial',40,'bold'),bd=2,fg="black",textvariable= PlayerX, width=14,
...
txtPlayerO=Button(RightFrame1,font=('arial',40,'bold'),bd=2,fg="black",textvariable= PlayerO, width=14,
...
ShowRules = Button(RightFrame2, text="Show Rules",  font=('arial', 40,'bold'), height = 1, width=20,fg='black', bg='yellow',command = showRules)
ShowRules.grid(row=3, column=0,padx = 6,pady =11)

btnNewGame = Button(RightFrame2, text="New  Game",  font=('arial', 40,'bold'), height = 1, width=20,fg='black', bg='yellow',command = Newgame)
btnNewGame.grid(row=4, column=0,padx = 6, pady =11)
