...
Tops = Frame(root,bg = '#ff984f',pady = 2, width =1350, height = 100, relief = RIDGE)
Tops.grid(row=0,column=0)
flag =0

lblTitle = Label(Tops,font=('arial',50,'bold'),text = "PyPower Presents Tic Tac Toe",bd = 21,fg='black', bg='#ff984f',justify = CENTER)
lblTitle.grid(row=0,column=0)

MainFrame = Frame(root,bg = '#ff5c75',pady = 2, width =1350, height = 100, relief = RIDGE)
MainFrame.grid(row=1,column=0)

LeftFrame = Frame(MainFrame ,bd=10, width =750, height=500, pady=2,padx=10,bg='#ffd9db'  ,relief=RIDGE)
LeftFrame.pack(side=LEFT)

RightFrame  =  Frame(MainFrame ,bd=10, width =750, height=500, padx=10,pady=2,bg='#ffd9db',relief=RIDGE)
RightFrame.pack(side=RIGHT)

RightFrame1 = Frame(RightFrame ,bd=10, width =600, height=200, padx=10,pady=2, bg='#ffd9db', relief=RIDGE)
RightFrame1.grid(row=0,column=0)

RightFrame2  =  Frame(RightFrame ,bd=10, width =560, height=400, padx=10,pady=2, bg='blue',relief=RIDGE)
...
txtPlayerX=Button(RightFrame1,font=('arial',26,'bold'),bd=2,fg="black",bg = "yellow",textvariable= PlayerX, width=7,
...
txtPlayerO=Button(RightFrame1,font=('arial',26,'bold'),bd=2,fg="black",bg = "yellow",textvariable= PlayerO, width=7,
...
btnNewGame = Button(RightFrame2, text="New  Game",  font=('arial', 40,'bold'), height = 1, width=20,fg='black', bg='#ff984f',command = Newgame)
btnNewGame.grid(row=2, column=0,padx = 6, pady =11)
